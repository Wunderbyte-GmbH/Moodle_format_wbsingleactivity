 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class format_wbsingleactivity_admin_setting_activitytype extends admin_setting_configselect {
    /**
    ...
    public function load_choices() {
        global $CFG;
        require_once($CFG->dirroot. '/course/format/wbsingleactivity/lib.php');
        if (is_array($this->choices)) {
            return true;
        }
        $this->choices = format_wbsingleactivity::get_supported_activities();
        return true;
    }
}
